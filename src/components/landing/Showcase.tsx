          ...
          <div className="w-full lg:w-1/2">
...

            {
              user ?
                ...
                <Button size="lg" variant="outline" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700" onClick={() => handleAuthClick('login')}>
                  Try It Now
