import { Clock, Layout, Aperture, Trash2 } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Trusted by over 10 users worldwide, built to make file management effortless and efficient.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
            ...
            <h3 className="text-xl font-semibold mb-2">Trash Bin</h3>
            <p className="text-gray-600 dark:text-gray-400">
              Deleted files are stored safely in the trash and can be restored anytime.
            </p>
          </div>
