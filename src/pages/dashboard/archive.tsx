...
import { Archive as ArchiveIcon, Clock, Download, Loader } from 'lucide-react';
    ...
    <DashboardLayout title="Archive">
      <div className="space-y-6">
        ...
        <div className="flex gap-4 mt-4 justify-center">
          ...
          <Button
            variant={'ghost'}
            disabled={meta! && filters.page === meta.total_pages || archives.length === 0}
            onClick={() => setFilters({ ...filters, page: (filters.page || 1) + 1 })}
          >
            Next
          </Button>
